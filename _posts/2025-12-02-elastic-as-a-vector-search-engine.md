...
![Elasticsearch and Kibana start-local setup output]({{ '/assets/images/elastic-as-a-vector-search-engine/start-local-setup.png' | relative_url }})
...
![Postman request adding documents to the test index]({{ '/assets/images/elastic-as-a-vector-search-engine/postman-add-doc.png' | relative_url }})
...
![Kibana index details view for the test index]({{ '/assets/images/elastic-as-a-vector-search-engine/kibana-index-view.png' | relative_url }})
